          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ background: '#FFFFFF', borderRadius: '16px', border: '1px solid #E2E8F0', padding: '14px 14px', boxShadow: '0 4px 12px rgba(0,0,0,0.02)', boxSizing: 'border-box', width: '100%', overflow: 'hidden' }}>
              ...
              <div className="range-field" style={{ marginBottom: '14px' }}>
                <div className="rf-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px', gap: '6px', width: '100%', minWidth: 0 }}>
                  <label style={{ fontSize: '0.84rem', fontWeight: 700, color: '#0F2942', flexShrink: 1, minWidth: 0, whiteSpace: 'nowrap' }}>Loan Amount</label>
                  <div
            ...
            <div className="calc-emi-card" style={{
              ...
              {/* Doughnut SVG Chart — restored 150px */}
              <div style={{ position: 'relative', width: '150px', height: '150px', margin: '0 auto 10px auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {/* Chart Legend */}
              <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', fontSize: '0.75rem', fontWeight: 600, marginBottom: '8px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px', marginBottom: '6px' }}>
                <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '8px', padding: '7px 8px' }}>
                  <div style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '0.92rem', fontWeight: 900, color: '#FFFFFF', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{fmtLakhCr(amount)}</div>
                  <div style={{ fontSize: '0.56rem', fontWeight: 800, color: '#94A3B8', marginTop: '1px', letterSpacing: '0.04em' }}>PRINCIPAL</div>
                </div>

                <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '8px', padding: '7px 8px' }}>
                  <div style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '0.92rem', fontWeight: 900, color: '#FFFFFF', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{fmtLakhCr(totalInterest)}</div>
                  <div style={{ fontSize: '0.56rem', fontWeight: 800, color: '#94A3B8', marginTop: '1px', letterSpacing: '0.04em' }}>TOTAL INTEREST</div>
                </div>
              </div>

              {/* 1 Full-Width Bottom Metric Box */}
              <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '8px', padding: '7px 10px' }}>
                <div style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '1.0rem', fontWeight: 900, color: '#38BDF8' }}>{fmtLakhCr(totalPayable)}</div>
                <div style={{ fontSize: '0.56rem', fontWeight: 800, color: '#94A3B8', marginTop: '1px', letterSpacing: '0.04em' }}>TOTAL AMOUNT PAYABLE</div>
              </div>
            </div>
          </div>
